...
import io.canvas.colors.databinding.ItemDeviceBinding
import timber.log.Timber

class DeviceListAdapter(private val viewModel: MainViewModel) :
    ...
    class ViewHolder private constructor(private val binding: ItemDeviceBinding) :
        ...
        fun bind(mainViewModel: MainViewModel, item: BLEDevice) {
